...
public class B_32511_TokenBankServices_History_PCHAPP_MiniReg extends Action_Wrapper {
	...
	public void story_B_32511_MT2_TokenBankService_History_PCHAPP() throws Exception {
		...
		CallJmeterBuild("B_32511_TokenBankServices_History_PCHAPP_MiniReg.jmx"); 
		Log.info("Calling  Jmeter file ");
		 
		Assert.assertEquals("false",xp.Xml_Parser("B_32511_TokenBankServices_History_PCHAPP_MiniReg.xml")); 
