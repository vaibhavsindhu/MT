...
public class B_35596_MT2_scoresubmit_PCHAPP_paytableValidations extends Action_Wrapper {
	...
	public void setup() throws Exception {
		...
		writeInProprtyFile("Access_Token_PLAYANDWIN", AccessToken.getAccessToken("PLAYANDWIN", "new"));
		copyAndRenameFile();
		...
		joomla.CG.setMaximumSubmissionAllowed(10);
	...
	public void story_B_35596_MT2_scoresubmit_PCHAPP_paytableValidations() throws Exception {
