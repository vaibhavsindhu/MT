...
public class B_36918_MT2_PCHApp_MetaActionBonusGameSupport_FriendsInvite_ErrorConditions extends Action_Wrapper {
	...
	String jmeterScriptName = "B_36918_MT2_PCHApp_MetaActionBonusGameSupport_FriendsInvite_ErrorConditions";


	@BeforeClass
	public void setup() throws Exception {

		startTestCase("B_36918_MT2_PCHApp_MetaActionBonusGameSupport_FriendsInvite_ErrorConditions");
	...
	public void story_B_36918_MT2_PCHApp_MetaActionBonusGameSupport_FriendsInvite_ErrorConditions() throws Exception {
		...
		//***** Bonus Submit with Friends as -1 in the Request
		response=RF.createFullRegUserAPI();
		GMT = RF.getResponseValueAPI(response,ResponseData.GlobalMemberToken);
		writeInProprtyFile("Encrypted_Email", getEncryptedData("Access_Token_PCHAPP", RF.getResponseValueAPI(response,ResponseData.Email)));
		writeInProprtyFile("Encrypted_GMT", getEncryptedData("Access_Token_PCHAPP",GMT));
		...
		joomla.article.navigateToArticleManager();
		joomla.PA.filterArticleByNames("14", "Bonus Reward for Facebook Friends");
		joomla.PA.editArticle("Bonus Reward for Facebook Friends", "unpublish");
		metaBonus.configureBonusAward("1000", "2", "1000");
