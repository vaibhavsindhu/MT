...
public class B_36918_MT2_PCHApp_MetaActionBonusGameSupport_FriendsInvite_Daily extends Action_Wrapper {
	...
	String jmeterScriptName = "B_36918_MT2_PCHApp_MetaActionBonusGameSupport_FriendsInvite_Daily";

	
	@BeforeClass
	public void setup() throws Exception {
		
		startTestCase("B_36918_MT2_PCHApp_MetaActionBonusGameSupport_FriendsInvite_Daily");
	...
	public void story_B_36918_MT2_PCHApp_MetaActionBonusGameSupport_FriendsInvite_Daily() throws Exception {
