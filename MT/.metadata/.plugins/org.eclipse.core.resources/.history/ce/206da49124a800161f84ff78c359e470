...
public class B_38146_MT2PCHAPP_GMTMandatory_PCHAPP extends Action_Wrapper {
	...
	public void setup() throws Exception {
		...
		startTestCase("B_38146_MT2PCHAPP_GMTMandatory_PCHAPP");
		...
		//enableThread("B_38146_MT2PCHAPP_GMTMandatory_PCHAPP.jmx", threadGroup);
				
	}

	@Test(groups = { GroupName.RegFoundation, GroupName.Regression,GroupName.PCHApp })
	public void story_B_38146_MT2PCHAPP_GMTMandatory_PCHAPP() throws Exception {

		//  *********************  Code Block for "Full Reg " Scenario ********************
		Log.info("Start Executing Jmeter Script");

		CallJmeterBuild("B_38146_MT2PCHAPP_GMTMandatory_PCHAPP.jmx");
		Log.info("JMX file Called");

		Log.info("Starting Assetion");
		Assert.assertEquals("false", xp.Xml_Parser("B_38146_MT2PCHAPP_GMTMandatory_PCHAPP.xml"));
		...
		Log.info("full User GMT  :"+GMT);
		Encrypted_Email=getEncryptedData("Access_Token_PCHAPP",RF.getResponseValueAPI(respon, ResponseData.Email));
		Encrypted_GMT=getEncryptedData("Access_Token_PCHAPP",RF.getResponseValueAPI(respon, ResponseData.GlobalMemberToken));
		writeInProprtyFile("Email", Email);
		writeInProprtyFile("GMT", GMT);
		writeInProprtyFile("Encrypted_Email", Encrypted_Email);
		writeInProprtyFile("Encrypted_GMT", Encrypted_GMT);
		...
		Log.info("full User GMT  :" + GMT);
		Encrypted_Email = getEncryptedData("Access_Token_PCHAPP",
				RF.getResponseValueAPI(resp, ResponseData.Email));
		Encrypted_GMT = getEncryptedData("Access_Token_PCHAPP",
		...
		Assert.assertEquals("false",
				xp.Xml_Parser("B_38146_MT2PCHAPP_GMTMandatory_PCHAPP.xml"));
		Log.info("Assetion Validation Completed for Mini Reg User ");
