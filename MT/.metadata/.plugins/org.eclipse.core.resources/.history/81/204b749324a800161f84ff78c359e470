...
public class B_35881_MT2_PCHApp_MetaActionBonusGameSupport_DaysInteract extends Action_Wrapper {
	...
	String appLoadDay3[]={"AppLoad - Days3"};
	String bnsSubmit1Day[]={"BonusSubmit -1st Day"};
	String tokenHis500[]={"TokenHistory -500"};
	String bnsSubmit2Day[]={"BonusSubmit - 2nd Day"};
	String tokenHis1000[]={"TokenHistory -1000"};
	String bnsSubmit3Day[]={"BonusSubmit - 3rd Day"};
	String tokenHismax[]={"TokenHistory-MaxToken"};
	
	RFTestPage RF = new RFTestPage();
	Jmeter_Xml_Parser xp = new Jmeter_Xml_Parser();
	String jmeterScriptName = "B_35881_MT2_PCHApp_MetaActionBonusGameSupport_DaysInteract";

	
	@BeforeClass
	public void setup() throws Exception {
		
		startTestCase("B_35881_MT2_PCHApp_MetaActionBonusGameSupport_DaysInteract");
		...
		metaBonus.configureBonusAward("500", "3", "5000");
	...
	public void story_B_35881_MT2_PCHApp_MetaActionBonusGameSupport_DaysInteract() throws Exception {
		...
		enableThread(jmeterScriptName+".jmx", tokenHis500);
		Log.info("Start Executing Jmeter Script");
		...
		//*****Thread to Validate the Token History
		enableThread(jmeterScriptName+".jmx", tokenHis1000);
		Log.info("Start Executing Jmeter Script");
		...
		// change the "date_played" to yesterday in Both the Table - for 3rd day
		DB.phpctrl_app_bonus_items_daily(GMT, "update date played");
		DB.phpctrl_app_bonus_items(GMT, "update date played");
				
		// Second Visit App Load
		enableThread(jmeterScriptName+".jmx", appLoadDay3);
		Log.info("Start Executing Jmeter Script");
		...
		//Repeat Visit Days Validation in "phpctrl_app_bonus_items_daily" table
		Assert.assertTrue(DB.phpctrl_app_bonus_items_daily(GMT,"get Bonus data").contains("\"repeatVisitDays\":3"));
				
				
		//******* Thread for Bonus Submit -3 : For Max Token bonus
		enableThread(jmeterScriptName+".jmx", bnsSubmit3Day);
		Log.info("Start Executing Jmeter Script");
		...
		//*****Thread to Validate the Token History
		enableThread(jmeterScriptName+".jmx", tokenHismax);
		Log.info("Start Executing Jmeter Script");
