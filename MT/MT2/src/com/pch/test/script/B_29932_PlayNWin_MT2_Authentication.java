...
public class B_29932_PlayNWin_MT2_Authentication extends Action_Wrapper {
	...
	public void setup() throws Exception {
		...
		clientListData=db.clientList("PLAYANDWIN");
	...
	public void BackLogItem_B_29932_PlayNWin_MT2_Authentication() throws Exception {
		
		Log.info("Start Executing Jmeter Script");
		
		CallJmeterBuild("B_29932_PlayNWin_MT2_Authentication.jmx");
		Log.info("JMX file Called");

		Assert.assertEquals("false", xp.Xml_Parser("B_29932_PlayNWin_MT2_Authentication.xml"));
