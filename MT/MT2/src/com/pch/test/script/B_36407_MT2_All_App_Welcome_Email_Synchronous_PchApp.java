...
public class B_36407_MT2_All_App_Welcome_Email_Synchronous_PchApp extends Action_Wrapper{
	...
	public void setup() throws Exception {
		startTestCase("B_36407_MT2_All_App_Welcome_Email_Synchronous_PchApp");
		...
		writeInProprtyFile("Email", getEncryptedData("Access_Token_PCHAPP", Email));
	...
	public void story_B_36407_MT2_All_App_Welcome_Email_Synchronous_PchApp() throws Exception {
		...
		Assert.assertEquals(DB.phpctrl_sso_properties(decrypt,"property"),"welcomeemail_pchapp","Validating the property from which welcome email triggered");
