...
public class B_31684_AllApps_MT2_ExposeAddPasswordAPI_PlayAndWin extends Action_Wrapper {
	...
	public void setup() throws Exception {
		...
		startTestCase("B_31684_AllApps_MT2_ExposeAddPasswordAPI_PlayAndWin");
		...
		Encrypted_Email = getEncryptedData("Access_Token_PLAYANDWIN",
				RF.getResponseValueAPI(response, ResponseData.Email));
	...
	public void story_B_31684_AllApps_MT2_ExposeAddPasswordAPI_PlayAndWin() throws Exception {
		...
		String Encrypted_Email = getEncryptedData("Access_Token_PLAYANDWIN", MiniRegEmail);
		...
		writeInProprtyFile("Encrypted_Email", getEncryptedData("Access_Token_PLAYANDWIN", FullRegEmail));
		writeInProprtyFile("Encrypted_GMT", getEncryptedData("Access_Token_PLAYANDWIN", GMT_FullReg));
		copyAndRenameFile();
