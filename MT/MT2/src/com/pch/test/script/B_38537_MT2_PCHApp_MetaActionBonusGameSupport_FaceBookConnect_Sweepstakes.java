...
public class B_38537_MT2_PCHApp_MetaActionBonusGameSupport_FaceBookConnect_Sweepstakes extends Action_Wrapper {
	...
	String jmeterScriptName = "B_38537_MT2_PCHApp_MetaActionBonusGameSupport_FaceBookConnect_Sweepstakes";
	String accessToken,response,GMT,Encrypted_Email,Encrypted_GMT,Email;
	RFTestPage RF = new RFTestPage();
	Jmeter_Xml_Parser xp = new Jmeter_Xml_Parser();
	
	
/*	String threadGroup1[]={"BonusSubmit","TokenHistory -1000","AppLoad1"};
	...
	public void setup() throws Exception {
		...
		startTestCase("B_38537_MT2_PCHApp_MetaActionBonusGameSupport_FaceBookConnect_Sweepstakes");
		...
		joomla.PA.bonusActionArticle("Standalone Sweeps game","Facebook_Connect");
