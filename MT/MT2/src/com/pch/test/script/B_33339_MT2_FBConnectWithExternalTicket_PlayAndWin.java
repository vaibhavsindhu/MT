...
public class B_33339_MT2_FBConnectWithExternalTicket_PlayAndWin  extends Action_Wrapper {
	...
	public void setup() throws Exception {
		...
		writeInProprtyFile("ExternalEnc_FullRegEmail", getEncryptedData("Access_Token_PLAYANDWIN",Email));
		...
		AuthTicket = RF.getTicketValue(ResponseData.AuthTicket);
		Log.info("Auth ticket is  :" + AuthTicket);
		writeInProprtyFile("Encrypted_MiniRegEmail", getEncryptedData("Access_Token_PLAYANDWIN",Email));
