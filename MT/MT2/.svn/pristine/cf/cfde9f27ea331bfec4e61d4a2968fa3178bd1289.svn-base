...
public class B_36327_PCH_App_MT2_Current_State_of_User_ContinuousGame_Score_Submit extends Action_Wrapper {
	...
	String threadGroupSecondScoreSubmit[] = {"Score Submit 2nd","AppLoad After second score submit"};
	...
	public void setup() throws Exception {
		...
		joomla.CG.configureTokePayablearticle("token paytable1", "150","1000","200","2000");

		closeallwindows();
		
		//DB.flush("PchApp", "DELETE FROM `phpctrl_app_content_tree`");
		//GETclearMemCache("Access_Token_PCHAPP");
		disableThread(scriptName+".jmx", threadGroupSecondScoreSubmit);
		
	}

	@Test(groups = { GroupName.Game, GroupName.Regression })
	public void story_B_36327_PCH_App_MT2_Current_State_of_User_ContinuousGame_Score_Submit()
			throws Exception {
		...
		enableThread(scriptName+".jmx", threadGroupSecondScoreSubmit);
