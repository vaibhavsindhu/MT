...
public class B_38537_MT2_PCHApp_MetaActionBonusGameSupport_FaceBookConnect_Lotto extends Action_Wrapper {
	...
	String jmeterScriptName = "B_38537_MT2_PCHApp_MetaActionBonusGameSupport_FaceBookConnect_Lotto";

	
	@BeforeClass
	public void setup() throws Exception {
		
		startTestCase("B_38537_MT2_PCHApp_MetaActionBonusGameSupport_FaceBookConnect_Lotto");
		...
		joomla.PA.bonusActionArticle("Lotto Bonus","Facebook_Connect");
	...
	public void story_B_38537_MT2_PCHApp_MetaActionBonusGameSupport_FaceBookConnect_Lotto() throws Exception {
