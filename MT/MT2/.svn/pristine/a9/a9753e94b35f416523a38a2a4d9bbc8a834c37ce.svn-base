...
public class B_35596_MT2_scoresubmit_PCHAPP_NoPaytableSelected extends Action_Wrapper{
	...
	String enableThread[] = {"AppLoad","Score Submit without paytable"};
	...
	public void setup() throws Exception {
		...
		joomla.CG.setMaximumDailyTokenPayout("20000");
		joomla.CG.setMinimumGameplayDuration(1);
		joomla.CG.setTokenPaytableDropDown(AppData.TokenPaytable.NoPaytableSelection);
		joomla.alias.saveAndClose();
	...
	public void story_B_35596_MT2_scoresubmit_PCHAPP_NoPaytableSelected() throws Exception {
		...
		disableThread(scriptName+".jmx",enableThread);
		Log.info("Start Executing Jmeter Script");
		CallJmeterBuild(scriptName+".jmx");
		Log.info("JMX file Called");
		Assert.assertEquals("false", xp.Xml_Parser(scriptName+".xml"));
