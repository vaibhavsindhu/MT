...
public class B_32299_MT2_miniRegister_Member_PCHAPP extends Action_Wrapper{
	...
	public void setup() throws Exception {
		...
		writeInProprtyFile("Encrypted_Email", getEncryptedData("Access_Token_PCHAPP", MiniUUser));
		copyAndRenameFile();
	...
	public void story_B_32299_MT2_miniRegister_Member_PCHAPP() throws Exception {
